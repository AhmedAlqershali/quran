...
Uri quranAppUrl=Uri.parse('https://www.facebook.com/profile.php?id=100085349281607');
...
Future saveSettings()async{
  ...
  await pref.setInt("moshafFontSize", arabicFontSize.toInt());
}
...
Future getSetting()async{
  try{
    ...
    moshafFontSize=await pref.getInt("moshafFontSize")!.toDouble();
  }catch(_){
    arabicFontSize=28;
    moshafFontSize=40;
